...
This project has an SEO engine that took real work to set up. Respect the rules below or `npm run lint:seo` will fail the build.
...
3. An `aggregateRating` JSON-LD field — this site is a finance/loan business; fake reviews violate Google policy and create legal liability.
